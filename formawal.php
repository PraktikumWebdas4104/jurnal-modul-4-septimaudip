<?php 
	...
	if (isset($_POST['submit'])) {
		if ($_POST['username']==$user['user'] && $_POST['password'] == $user['pass']) {
			...
			echo "<h1>APLIKASI PEMBELAJARAN</h1><br>";
			echo "Anda Berhasil login $_POST[username]<br>";
			echo "Silahkan daftar terlebih dahulu dengan mengisi form untuk mengetahui kepribadian anda <a href ='proses.php'>Klik isi form</a>";
			# code...
		}else{
			display_login_form();
